    ...
    <div class="container mt-5">
        ...
        <div class="result-display p-4 border rounded bg-light">
            ...
            if (isset($_POST['Submit'])){
                ...
                // แสดงสีในช่องที่มีขนาดชัดเจนขึ้น
                echo '<p class="d-flex align-items-center"><strong>สีที่ชอบ:</strong> '.$color.' 
                    <span style="display:inline-block; width: 40px; height: 20px; background-color:'.$color.'; border: 1px solid #ccc; margin-left: 10px;"></span>
                </p>';
                echo "<p><strong>สาขาวิชา:</strong> ".$major."</p>";	
            } else {
                echo "<p class='text-muted'>กรุณากรอกข้อมูลและกดปุ่ม 'สมัครสมาชิก' เพื่อดูผลลัพธ์</p>";
            }
            ?>
        </div>
        </div>
